...
public class EntityExplodeStorageEvent extends StorageEvent
{
	private static final HandlerList handlerList = new HandlerList();
    private boolean cancelBreak = false;
	
    public EntityExplodeStorageEvent(Entity breakingEntity, Set<SBaseBlock> sBlocks, Set<Block> blocks) {
